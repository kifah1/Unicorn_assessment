...
CREATE TABLE `book_a_slot` (
  ...
  `exceeding_6_hrs` varchar(256) DEFAULT NULL,
...
INSERT INTO `book_a_slot` (`id`, `registration_id`, `department_id`, `doctor_users_id`, `Patient_ID`, `request_date`, `request_time`, `exceeding_6_hrs`, `subject`, `doctor_type_id`, `fee_type`, `fee_amount`, `description`, `doctor_comments`, `created_at`, `updated_at`, `status`) VALUES
(26, 1, 4, 14, 'e1599c39ef', '2019-10-15', '11:40 am', 'yes', '43434', 1, 'General', '260.00', '54545', NULL, '2019-10-15 15:08:28', NULL, 'approved');
